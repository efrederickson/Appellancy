...
-(void)updateStatusText:(id)arg1 subtitle:(id)arg2 animated:(bool)arg3; // 8.X
-(void)_updateStatusText:(id)arg1 animated:(BOOL)arg2 ; // 7.0
-(void)_updateStatusText:(id)arg1 subtitle:(id)arg2 animated:(BOOL)arg3; // 7.1
